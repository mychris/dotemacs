...
#+begin_src emacs-lisp
  (use-package evil-escape
    ...
    (defun +evil-escape-mode-toggle ()
      "Enable/Disable `evil-escape-mode' dependend on the status of the `evil-mode'."
      (eval-and-compile (require 'evil-core))
...
#+begin_src emacs-lisp
  (use-package orderless
    :ensure t
    :demand t ;; If it is lazy loaded, a message is show in the minibuffer the
...
#+begin_src emacs-lisp
  ...
  (use-package which-key-posframe
    ...
    (defun +which-key-posframe-mode-toggle ()
      "Enable/Disable `which-key-posframe-mode' dependend on the status of the
  `which-key-mode'."
      (eval-and-compile (require 'which-key))
      (which-key-posframe-mode (if which-key-mode 1 -1)))
...
#+begin_src emacs-lisp
  (use-package undo-tree
    :ensure t
    :demand t ;; we always want the undo tree and its presistance.
...
#+begin_src emacs-lisp
  (use-package replace
    ...
    :bind (("M-%" . query-replace)
           ...
           ("^" . my/occur-mode-move-beginnig-of-line)
           ("q" . kill-buffer-and-window)
           ("<up>" . previous-line)
           ("<down>" . next-line)
           ("j" . next-line)
...
#+begin_src emacs-lisp
  (use-package term
    :ensure nil
    :config
    (defun my/kill-term-process-sentinel ()
    ...
    (term-exec-hook . my/kill-term-process-sentinel)
...
#+begin_src emacs-lisp
  ...
  (use-package flycheck-popup-tip
    ...
    (defun +flycheck-popup-tip-mode-toggle ()
      "Enable/Disable `flycheck-popup-tip-mode' dependend on the status of the
  `flycheck-mode'."
      (eval-and-compile (require 'flycheck))
      (flycheck-popup-tip-mode (if flycheck-mode 1 -1)))
    :hook
