...
#+begin_src emacs-lisp
  ...
  (use-package which-key-posframe
    ...
    (which-key-posframe-poshandler #'my/which-key-posframe-poshandler)
    (which-key-posframe-border-width 2)
    :init
    (defun my/which-key-posframe-poshandler (info)
